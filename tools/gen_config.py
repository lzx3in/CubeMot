...
class ConfigTree:
    ...
    def __init__(self, kconf: kconfiglib.Kconfig):
        ...
        self.root = ConfigNode(
            name=kconf.mainmenu_text or "Configuration",
    ...
    def _merge_symbol_nodes(self) -> None:
        ...
        def remove_duplicates(node: ConfigNode) -> None:
            node.children = [c for c in node.children if not getattr(c, '_is_duplicate', False)]
    ...
    def format_tree(self, show_values: bool = True) -> str:
        ...
        def format_node(node: ConfigNode, prefix: str = "", is_last: bool = True) -> None:
...
def parse_args() -> SConf:
    ...
    parser.add_argument('--tree', action='store_true',
                        help='Display the configuration tree')
