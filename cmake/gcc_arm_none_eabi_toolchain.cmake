...
# Map file path must be absolute to ensure consistent placement across CMake generators
set(CMAKE_EXE_LINKER_FLAGS "${CMAKE_EXE_LINKER_FLAGS} -Wl,-Map=${CMAKE_BINARY_DIR}/${CMAKE_PROJECT_NAME}.map -Wl,--gc-sections")
